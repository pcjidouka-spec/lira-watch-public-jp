...
{
  id: 'swap-arbitrage-capital-efficiency-202608',
  title: 'スワップ裁定はどの通貨ペアが一番効率的か？ 実データで比較したら、スイスフラン/トルコリラが南アランド/円の6倍だった',
  share_title: 'スワップ裁定の資本効率を実データ比較。CHF/TRYが最良',
  x_post: `業者間スワップ裁定の資本効率を実データで比較

・スイスフラン/トルコリラが最良。年率約57％
・南アランド/円 約9％、トルコリラ/円 約16％
・LIGHT FXの支払スワップが他社の半分なのが源泉`,
  date: '2026/08/28',
  thumbnail: '/images/swap-arbitrage-capital-efficiency-202608_60.png',
  tags: ['FX', 'トルコリラ', '南アフリカランド', 'スワップ投資', '裁定取引'],
  content: `
    <p class="intro">
      業者間のスワップ差を取る「裁定（サヤ取り）」は、どの通貨ペアで組むのが一番効率的なのか。<br>
      当サイトが毎日集計している各社のスワップ実績データで、<strong>スイスフラン/トルコリラ・南アフリカランド/円・トルコリラ/円</strong>の3ペアを比較しました。<br>
      結論は明快で、<strong>スイスフラン/トルコリラが圧倒的</strong>です。
    </p>

    <h3>【裁定の仕組み：業者間で両建てする】</h3>
    <p>同じ通貨ペアを、<strong>買スワップが最も高い業者で買い、売スワップが最も有利な業者で売る</strong>だけです。買いと売りが同量なので為替の値動きは相殺され、スワップの差額だけが残ります。</p>
    <p>以下は2026年7月22日〜8月27日（27営業日）の当サイト集計データによる平均値です。数量は1万通貨・1日あたりで統一しています。</p>
    ...
    <table class="article-table">
      ...
      <tbody>
        <tr>
          <td><strong>スイスフラン/トルコリラ</strong></td>
          <td>LIGHT FX（−992円）</td>
          <td>外為どっとコム（＋1,749円）</td>
          <td><strong style="color: #ef4444;">＋587円/日</strong></td>
        </tr>
        <tr>
          <td>南アフリカランド/円</td>
          <td>みんなのFX（＋15.2円）</td>
        ...
        <tr>
          <td>トルコリラ/円</td>
          <td>GMOクリック証券（＋25.0円）</td>
          <td>くりっく365（−24.4円）</td>
          <td>＋2.46円/日</td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※スイスフラン/トルコリラは27営業日中24日でこの組み合わせが最良でした。</p>
    ...
    <table class="article-table">
      ...
      <tbody>
        <tr><td>1万通貨の想定元本</td><td>197.9万円</td><td>9.97万円</td><td>3.31万円</td></tr>
        <tr><td>年間の裁定益</td><td>214,390円</td><td>1,836円</td><td>898円</td></tr>
        <tr><td>想定元本ベースの年率</td><td><strong>10.83％</strong></td><td>1.84％</td><td>2.71％</td></tr>
        <tr><td>必要証拠金のみ（8％）</td><td><strong>135.4％</strong></td><td>23.0％</td><td>33.9％</td></tr>
        <tr><td><strong>現実的な資本ベース</strong></td><td><strong style="color: #ef4444;">約57％</strong></td><td>約9％</td><td>約16％</td></tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※証拠金は個人の上限レバレッジ25倍（元本の4％）×2脚＝8％。「現実的な資本ベース」は、これに各ペアの実測21日間最大変動幅の2倍をバッファとして加えたものです（CHF/TRY 11％、ZAR/JPY 13％、TRY/JPY 9％）。1万通貨あたりの必要資本はそれぞれ約37.6万円・約2.1万円・約0.57万円です。</p>
    <p><strong>スイスフラン/トルコリラは、南アフリカランド/円の約6倍、トルコリラ/円の約3.6倍の資本効率</strong>という結果になりました。</p>

    <h3>【なぜスイスフラン/トルコリラだけ突出するのか】</h3>
    <p>理論値（トルコの政策金利−スイスの金利）で計算すると、1万通貨のスワップは1日あたり約2,100円です。これに対して各社の提示は次のようになっています。</p>
    <ul>
      <li>外為どっとコム（売）：＋1,749円 ＝ 理論値の約<strong>83％</strong>を払い出している</li>
      <li>LIGHT FX・みんなのFX（買）：−992円 ＝ 理論値の約<strong>47％</strong>しか徴収していない</li>
    </ul>
    <p>つまり<strong>LIGHT FX 側の支払いスワップが他社の半分に抑えられている</strong>ことが、裁定余地の正体です。異常値ではなく業者ごとのポリシーの差で、当サイトが8月に全社調査したときも同じ傾向でした。</p>
    <p>一方で南アフリカランド/円やトルコリラ/円は、各社とも買スワップと売スワップがほぼ対称（買＝−売）です。裁定余地は薄くしか残りません。</p>

    <h3>【意外：値動きはスイスフラン/トルコリラの方が穏やか】</h3>
    <p>トルコリラが絡むと荒いイメージがありますが、直近1年の実測では逆でした。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>通貨ペア</th>
      ...
      <tbody>
        <tr><td>スイスフラン/トルコリラ</td><td><strong>6.8％</strong></td><td>1.4％</td><td>5.5％</td></tr>
        <tr><td>南アフリカランド/円</td><td>11.5％</td><td>3.2％</td><td>6.4％</td></tr>
        <tr><td>トルコリラ/円</td><td>7.9％</td><td>2.6％</td><td>4.6％</td></tr>
      </tbody>
    </table>
    <p>トルコリラは「管理された緩やかな下落」が続いているため、日々の跳ねが小さいのです。必要バッファの面でもスイスフラン/トルコリラは不利になりません。</p>

    <h3>【スプレッドは何日で回収できるか】</h3>
    <table class="article-table">
      <thead>
        <tr>
          <th>通貨ペア</th>
      ...
      <tbody>
        <tr><td>スイスフラン/トルコリラ</td><td>約6,600円</td><td><strong>約11日</strong></td></tr>
        <tr><td>南アフリカランド/円</td><td>約290円</td><td>約58日</td></tr>
        <tr><td>トルコリラ/円</td><td>約280円</td><td>約118日</td></tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※スイスフラン/トルコリラは変動スプレッドで公表値がないため、100pips/脚と仮定した試算です。300pips/脚でも回収34日で、結論は変わりません。トルコリラ/円は118日かかり、短期では割に合いません。</p>

    <h3>【リスクと注意点】</h3>
    <p>数字は魅力的ですが、これは通常のスワップ投資とは別物のリスクを抱えた手法です。</p>
    <ul>
      <li><strong>証拠金が一方向に移動し続けます。</strong> スイスフラン/トルコリラは1年で17.5％上昇（＝トルコリラ安）しました。売り建てしている外為どっとコム側は1万通貨あたり年約35万円を失い、LIGHT FX 側が同額増えます。損益は相殺されますが、<strong>定期的に業者間で資金を移し替える手間が必須</strong>です。上の「約57％」は月次リバランスを前提にしています。</li>
      <li><strong>利回りの源泉は1社のスワップ設定です。</strong> LIGHT FX が支払いスワップを他社水準に戻せば、裁定余地は即座に消えます。観測期間27営業日での裁定益は＋245円〜＋852円/日と幅がありました。</li>
      <li><strong>トルコリラの急変リスクは直近1年のデータに含まれていません。</strong> 2018年は数日で約25％、2021年は1日で約15％下落した実績があります。上記のバッファでは足りません。</li>
      <li><strong>異業者間の両建てについては、必ず各社の取引規約を確認してください。</strong> 特に海外業者との組み合わせは禁止されていることが多く、国内業者同士でも「不当な取引」に関する条項が置かれている場合があります。</li>
      <li>ソニー銀行の南アフリカランド/円スプレッドは当サイト未取得のため、2銭と仮定しています。</li>
    </ul>

    <hr style="margin: 30px 0; border: 0; border-top: 1px solid #eee;">

    <p>
      <strong>結論：スイスフラン/トルコリラが最良で、現実的な資本ベースで年率約57％。</strong>南アフリカランド/円（約9％）の6倍、トルコリラ/円（約16％）の3.6倍でした。<br>
      ただし利回りの源泉が「1社のスワップ設定の偏り」である以上、いつ消えてもおかしくありません。取り組むなら、規約の確認と資金移動の運用設計をセットで考えてください。
    </p>
    <p style="font-size: 0.9em; color: #666;">※本記事は当サイトが集計した公開データにもとづく試算であり、特定の取引を推奨するものではありません。スワップポイントは各社の判断で日々変動し、記載の水準が続く保証はありません。投資判断はご自身の責任でお願いします。</p>
  `
},
{
  id: 'gaitame-swap-campaign-202609',
  title: '外為どっとコムのスワップ増額キャンペーンが9月も開催。ただし今回は「最大30％」で先月の半分です',
  share_title: 'スワップ最大30％増額キャンペーン（9月・外為どっとコム）',
  x_post: `外為どっとコムのスワップ増額が9月も開催（8/31〜9/26）

・今回は最大30％。先月の60％から半減
・公式シミュレーション合計40,955円相当
・スプレッドを引くと他社との差はほぼ消えます`,
  date: '2026/08/28',
  thumbnail: '/images/gaitame-swap-campaign-202609_60.png',
  tags: ['FX', 'トルコリラ', 'スワップ投資', '外為どっとコム', 'キャンペーン'],
  content: `
    <p class="intro">
      外為どっとコムにて、2026年9月も<strong>「入金額に応じてスワップポイント最大30％増額キャンペーン」</strong>が開催されます。<br>
      先に正直なところを書いておくと、<strong>今回は控えめです。</strong>先月までの「最大60％」が<strong>今月は「最大30％」と半分</strong>になり、対象は引き続きトルコリラ/円（買）・米ドル/トルコリラ（売）・ユーロ/トルコリラ（売）の3ペアです。
    </p>

    <h3>【まずは結論：合計でいくら上乗せ？】</h3>
    <p>公式シミュレーションでは、対象3通貨ペアを組み合わせて運用した場合、合計で次のポイントが上乗せされます。</p>
    <ul>
      <li><strong>入金100万円以上（30％）：</strong> 合計 <span style="color: #ef4444; font-weight: bold;">40,955円相当</span> のFXポイント上乗せ</li>
      <li><strong>入金10万円以上〜100万円未満（10％）：</strong> 合計 <span style="color: #ef4444; font-weight: bold;">13,715円相当</span> のFXポイント上乗せ</li>
    </ul>

    <h3>【先月との比較：率も単価も下がっています】</h3>
    <p>8月のキャンペーンと並べると、今回の控えめさがはっきりします。対象ペアも上限Lotも同じで、変わったのは増額率と単価です。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th></th>
      ...
      <tbody>
        <tr><td>最大増額率（USD/TRY・EUR/TRY）</td><td>60％</td><td><span style="color: #ef4444; font-weight: bold;">30％</span></td></tr>
        <tr><td>最大増額率（TRY/JPY）</td><td>30％</td><td><span style="color: #ef4444; font-weight: bold;">30％</span></td></tr>
        <tr><td>1Lot単価（米ドル/トルコリラ）</td><td>47.30円</td><td>25.10円</td></tr>
        <tr><td>1Lot単価（ユーロ/トルコリラ）</td><td>58.00円</td><td>30.30円</td></tr>
        <tr><td>1Lot単価（トルコリラ/円）</td><td>0.72円</td><td>0.71円</td></tr>
        <tr><td>公式シミュレーション合計（最大）</td><td>64,960円相当</td><td><span style="color: #ef4444; font-weight: bold;">40,955円相当</span></td></tr>
      </tbody>
    </table>
    <p>
      注目したいのは、<strong>トルコリラ/円（買）だけは実質据え置き</strong>だという点です。最大増額率は先月も今月も共に30％、1Lot単価も0.72円→0.71円とほぼ変わっていません。<br>
      半分になったのは米ドル/トルコリラとユーロ/トルコリラの方です。<strong>トルコリラ/円を買うだけの人にとっては、先月とほぼ同じ条件</strong>と考えて問題ありません。
    </p>

    <h3>【通貨ペア別：増額率（今月は3ペアとも同率）】</h3>
    <p>先月まではトルコリラ/円だけ率が低く設定されていましたが、今月は3ペアとも同じ率です。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        <tr>
          <td>米ドル/トルコリラ（売）</td>
          <td>10％</td>
          <td><strong style="color: #ef4444;">30％</strong></td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売）</td>
          <td>10％</td>
    ...
    <h3>【通貨ペア別：シミュレーション内訳（最大30％時）】</h3>
    <p>合計40,955円相当の内訳は、公式シミュレーションで3通貨ペアそれぞれ次の保有例で計算されています（1Lot＝1,000通貨）。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        <tr>
          <td>米ドル/トルコリラ（売）</td>
          <td>100Lot（10万通貨）を6日分（9/7建て〜9/11決済）</td>
          <td><strong>15,060円相当</strong></td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売）</td>
          <td>100Lotを5日分＋50Lotを1日分（9/14建て〜9/18全決済）</td>
          <td><strong>16,665円相当</strong></td>
        </tr>
        <tr>
          <td>トルコリラ/円（買）</td>
          <td>1,000Lot（100万通貨）を13日分（8/31建て〜9/11決済）</td>
          <td><strong>9,230円相当</strong></td>
        </tr>
        <tr>
          <td><strong>合計</strong></td>
          <td>—</td>
          <td><strong style="color: #ef4444;">40,955円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※入金10万円以上〜100万円未満（10％）の場合、公式では合計13,715円相当です。端数処理の関係で、30％時の単純な3分の1とは一致しません。</p>

    <h3>【通貨ペア別：1日あたりの上乗せ目安】</h3>
    <p>最大30％が適用された場合に、一定数量を1日保有したときの上乗せ目安は次の通りです。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
    ...
    <p style="font-size: 0.9em; color: #666;">※公式の1Lotあたり単価（米ドル/トルコリラ25.10円、ユーロ/トルコリラ30.30円、トルコリラ/円0.71円）から換算した目安です。</p>

    <h3>【上限Lotまで建てたら？キャンペーン期間中、最大上乗せ】</h3>
    <p>上乗せ対象の上限数量を全ペア同時に建て、キャンペーン期間をフルに保有した場合、上乗せは最大で次の通りです（公式単価からの当サイト試算）。</p>
    <p style="font-size: 0.9em; color: #666;">※付与日数は27日で計算（公式シミュレーション例から逆算。8月31日建て〜9月25日金曜クローズ、水曜クローズは3日分付与のため）。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        <tr>
          <td>米ドル/トルコリラ（売・30％）</td>
          <td>100Lot（10万通貨）</td>
          <td>約2,510円</td>
          <td>約67,770円相当</td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売・30％）</td>
          <td>100Lot（10万通貨）</td>
          <td>約3,030円</td>
          <td>約81,810円相当</td>
        </tr>
        ...
        <tr>
          ...
          <td>—</td>
          <td>約6,250円</td>
          <td><strong style="color: #ef4444;">約168,750円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※入金100万円以上（30％）で全ペア上限Lotをフル期間保有した理論上の最大値です。先月（60％時の当サイト試算で約303,750円）のおよそ半分です。入金10万円以上〜100万円未満（10％）なら約56,000円相当が目安です。実際にはこの規模の建玉には多額の証拠金が必要で、スワップも日々変動します。あくまで上限の目安としてご覧ください。</p>

    <h3>【30％で他社に勝てる？ スプレッドを引くと差はほぼ消えます】</h3>
    <p>トルコリラ/円は他社のスワップと直接、米ドル/トルコリラ・ユーロ/トルコリラは扱う業者が少ないため他社で組んだ合成ポジションと比べました。増額後なら、3ペアとも上回ります。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア</th>
          <th>外為どっとコム（30％増額後）</th>
          <th>他社の最高値</th>
          <th>差</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td>トルコリラ/円（買）</td>
          <td><strong>約30.8円</strong></td>
          <td>約25.0円（GMOクリック証券・マネースクエア）</td>
          <td>＋5.8円</td>
        </tr>
        <tr>
          <td>米ドル/トルコリラ（売）</td>
          <td><strong>約1,088円</strong></td>
          <td>約1,067円（GMOクリック証券・合成）</td>
          <td>＋21円</td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売）</td>
          <td><strong>約1,313円</strong></td>
          <td>約1,303円（GMOクリック証券・合成）</td>
          <td>＋10円</td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※1万通貨・1日あたりの当サイト試算です。</p>

    <p>ただし、<strong>このキャンペーンは毎月ポジションを建て直す必要があり、そのたびにスプレッドを払います</strong>。外為どっとコムのスプレッドはトルコリラ/円1.4銭・米ドル/トルコリラ30pips・ユーロ/トルコリラ50pips（後者2つは変動、他社より広い）で、1万通貨あたり140円・993円・1,656円かかります。これを引くと評価が変わります。</p>
    <ul>
      <li><strong>トルコリラ/円：上乗せ192円のうち140円がスプレッドで消えます</strong>。他社トップとの差は1万通貨あたり月16円程度で、ほぼ互角です（上限100万通貨でも月1,600円程度）。</li>
      <li><strong>米ドル/トルコリラ：約15ヶ月</strong>より長く保有するなら、他社の合成の方が有利です。</li>
      <li><strong>ユーロ/トルコリラ：約6ヶ月</strong>より長く保有するなら、他社の合成の方が有利です。</li>
    </ul>
    <p>先月の60％増額なら、毎月スプレッドを払っても他社に勝ち続けられました。30％になったことで、<strong>数ヶ月単位で回すなら妙味あり、何年も持つなら他社で持ちっぱなしのほうが有利</strong>、という水準に変わっています。</p>
    <p style="font-size: 0.9em; color: #666;">※当サイト試算です。スワップは外為どっとコムの平均値集計期間（2026年7月27日〜8月21日）に揃えた各社平均、レートは2026年8月27日時点。他社側のスプレッドも初回コストとして計上しています。合成は2〜3ポジション必要で、証拠金や管理の手間は別途かかります。</p>

    <h3>【キャンペーン概要】</h3>
    <div class="campaign-details">
      <ul>
        <li><strong>対象期間：</strong> 2026年8月31日(月)午前7時00分 ～ 2026年9月26日(土)午前5時55分</li>
        <li><strong>条件：</strong> 期間中の純増額（入金−出金）が10万円以上で10％増額、100万円以上で30％増額</li>
        ...
        <li>
          ...
          ・米ドル/トルコリラ・ユーロ/トルコリラ：各100Lot（10万通貨）まで</li>
        <li><strong>特典付与：</strong> 2026年10月末までに『らくらくFX積立』口座へFXポイント付与（1ポイント＝1円）</li>
      </ul>
    </div>
    ...
    <ul>
      ...
      <li>特典のFXポイントを受け取るには、期間終了日時時点で<strong>『らくらくFX積立』の口座開設</strong>が必要です。未開設だと付与対象外になります。</li>
      <li>上乗せ額は、平均値集計期間（2026年7月27日〜8月21日）の受取スワップポイント平均値を基準に算出されます。</li>
      <li>キャンペーン開始前から保有しているポジション、新規建て当日中に決済したポジションは対象外です。</li>
      <li>指定された売買区分以外のポジション（例：トルコリラ/円の売）は対象外です。</li>
      <li>上乗せ額の1円未満は切り捨てられ、付与されません。</li>
    </ul>

    <hr style="margin: 30px 0; border: 0; border-top: 1px solid #eee;">

    <p>
      今回は「最大60％」から「最大30％」への引き下げで、米ドル/トルコリラ・ユーロ/トルコリラを狙っていた人には物足りない内容です。<br>
      一方で<strong>トルコリラ/円（買）の条件は先月とほとんど変わらず</strong>、上限の100万通貨をフル保有すれば約19,170円相当の上乗せになります。トルコリラ/円の長期保有を続けているなら、エントリーだけは済ませておきましょう。申し込みは無料です。
    </p>

    <div class="campaign-link" style="margin-top: 30px;">
      <p style="font-weight: bold; color: #2563eb;">▼キャンペーンの詳細とエントリーはこちら</p>
      <a href="https://www.gaitame.com/campaign/increase-swap-2609/" target="_blank" rel="noopener noreferrer">
        https://www.gaitame.com/campaign/increase-swap-2609/
      </a>
    </div>
  `
},
...
・上限フル保有すると約2,684円`,
  ...
  content: `
    <p class="intro">
      トライオートFXが、トルコリラ/円のスワップポイントを<strong>50％上乗せ</strong>するキャンペーンを開催中です。<br>
      上乗せ額は<strong>1万通貨あたり12.2円/日</strong>。期間は<strong>2026年8月10日（月）〜8月31日（月）</strong>の約3週間です。<br>
      増額率は7月の20％から50％へ戻りました。ただし<strong>建玉の上限が50万通貨→10万通貨と5分の1に縮小</strong>しています。単価は強いが規模は小さい、という内容です。
    </p>

    <h3><a href="https://www.invast.jp/campaign/fx/tryjpy-202608/" target="_blank" rel="noopener noreferrer">トライオートFX：トルコリラ/円スワップポイント50％増額キャンペーン -2026年8月</a></h3>
    <p class="campaign-title" style="color: #ef4444; font-weight: bold; font-size: 1.1em;">応募フォームからのエントリーが必須です。申し込まないと1円も増えません。</p>

    <h3>【まずは結論：いくら上乗せされる？】</h3>
    <p>上乗せ単価は公式発表で <strong>1万通貨あたり12.2円/日</strong>。建玉の上限は10万通貨です。</p>
    <ul>
      <li><strong>1万通貨：</strong> 12.2円/日（公式）</li>
      <li><strong>上限の10万通貨：</strong> <span style="color: #ef4444; font-weight: bold;">122円/日</span>（当サイト試算）</li>
      <li><strong>10万通貨を全期間フル保有：</strong> <span style="color: #ef4444; font-weight: bold;">約2,684円</span>（当サイト試算）</li>
    </ul>
    ...
    <table class="article-table">
      ...
      <tbody>
        <tr><td>1万通貨</td><td>12.2円</td><td>約268円</td></tr>
        <tr><td>3万通貨</td><td>36.6円</td><td>約805円</td></tr>
        <tr><td>5万通貨</td><td>61円</td><td>約1,342円</td></tr>
        <tr><td>10万通貨（上限）</td><td>122円</td><td>約2,684円</td></tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">
      ※公式が発表しているのは「1万通貨あたり12.2円/日」のみです。上の表は当サイトが12.2円/日を掛け算した試算です。<br>
      ※全期間は8月10日から8月31日まで建玉を持ち続けた場合の付与日数22日（水曜クローズは3日分）で計算しています。実際の付与日数は変動します。<br>
      ※為替変動による損失がスワップの上乗せ分を上回る可能性があります。
    </p>

    <h3>【上乗せ単価は本物：公式の12.2円は当サイトのデータでも裏が取れます】</h3>
    <p>
      公式は上乗せ単価の根拠を「2026年7月1日〜7月28日における受取スワップポイント平均値の50％」としています。<br>
      当サイトが毎日取得しているトライオートFXの買スワップで同じ期間を平均すると<strong>24.51円/日</strong>。その50％は<strong>12.25円</strong>で、公式の12.2円とぴたりと一致します。単価の水増しはありません。
    </p>

    <h3>【他社と比べるとどうか（当サイト実測・直近約2週間／2026年8月7日時点）】</h3>
    <p>トライオートFXの通常スワップは24.1円で、実は5位です。ただし12.2円が上乗せされると実質36.3円相当となり、他社を大きく引き離します。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>FX会社</th>
      ...
      <tbody>
        <tr>
          <td><strong>トライオートFX</strong></td>
          <td>24.1円</td>
          <td><strong style="color: #ef4444;">36.3円相当</strong></td>
        </tr>
        <tr>
          <td>GMOクリック証券</td>
          <td>25.0円</td>
    ...
    <p style="font-size: 0.9em; color: #666;">※当サイトが毎日取得している買スワップ（1万通貨・1日あたり）の直近約2週間平均です。実質欄はキャンペーンの計算式に当てはめた当サイト試算です。</p>

    <h3>【正直な評価：率は戻ったが、上限は5分の1。総額は過去最小です】</h3>
    <p>増額率だけを見れば7月の20％から50％へ改善しました。しかし建玉上限が10万通貨に絞られたため、上限まで建てても総額は約2,684円。<strong>過去4回で最も小さい</strong>金額です。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th></th>
      ...
      <tbody>
        <tr><td>増額率</td><td>60％</td><td>50％</td><td>20％</td><td><span style="color: #ef4444; font-weight: bold;">50％</span></td></tr>
        <tr><td>上乗せ単価<br>（1万通貨）</td><td>—</td><td>13.5円/日</td><td>5.1円/日</td><td>12.2円/日</td></tr>
        <tr><td>期間</td><td>2/2〜2/27<br>（約4週間）</td><td>5/1〜5/29<br>（約4週間）</td><td>7/15〜7/31<br>（約2週間）</td><td>8/10〜8/31<br>（約3週間）</td></tr>
        <tr><td>建玉上限</td><td>100万通貨</td><td>50万通貨</td><td>50万通貨</td><td><span style="color: #ef4444; font-weight: bold;">10万通貨</span></td></tr>
        <tr><td>上限フル保有の上乗せ額<br>（当サイト試算）</td><td>—</td><td>約19,575円</td><td>約4,845円</td><td><span style="color: #ef4444; font-weight: bold;">約2,684円</span></td></tr>
      </tbody>
    </table>
    <p>
      上乗せ単価から元のスワップ水準を逆算すると、5月が27.0円、7月が25.5円、今回が24.4円。<strong>スワップの原資は少しずつ下がっていますが、率を削ったわけではありません</strong>。総額が縮んだ理由は、ほぼ建玉上限の引き下げだけです。<br>
      2月は60％増額かつ上限100万通貨でした。半年で上限は10分の1になっています。
    </p>
    <p>
      ただし、これは<strong>大口ほど不利、小口には無関係</strong>という話です。もともと10万通貨までしか建てない人にとっては、単価12.2円/日は5月の13.5円/日にほぼ並ぶ水準で、7月の5.1円/日の2倍以上。<strong>少額で回している人には過去2番目に良い条件</strong>になります。
    </p>

    <h3>【対象は「増加分」だけ。すでに持っている建玉は対象外】</h3>
    <p>ここが一番の注意点です。対象になるのは<strong>基準日より増えた分</strong>だけです。</p>
    <ul>
      <li><strong>基準日：</strong> 2026年8月7日（金）クローズ時点の建玉数量</li>
      <li><strong>例1：</strong> 基準日に買建玉なし → 新規の買建玉すべてが対象（上限10万通貨）</li>
      <li><strong>例2：</strong> 基準日に5万通貨保有 → 8万通貨に増やすと、増加分の3万通貨だけが対象</li>
    </ul>
    <p>つまり、すでにトルコリラ/円を建てている人が上乗せを受けるには買い増しが必要です。上限が10万通貨と低いので、既存建玉が多い人ほど旨みは薄くなります。</p>

    <div class="campaign-details">
      <p><strong>開催期間：</strong> 2026年8月10日（月）取引開始 ～ 8月31日（月）取引終了</p>
      <p><strong>対象者：</strong> キャンペーン期間中に応募フォームから申し込みを行ったお客様</p>
      <p><strong>特典内容：</strong> トルコリラ/円（TRY/JPY）の買建玉の増加分に対し、スワップポイントを50％上乗せしてキャッシュバック</p>
      <p><strong>上乗せ単価：</strong> 1万通貨あたり12.2円/日（2026年7月1日〜7月28日の受取スワップポイント平均値の50％）</p>
      <p><strong>対象建玉の上限：</strong> 10万通貨</p>
      <p><strong>入金時期：</strong> 2026年9月末まで</p>
      <p><strong>注意事項：</strong>
        <ul>
          <li>応募フォームからのエントリーが必要です。登録がない場合や入力不備がある場合は対象外です。</li>
          <li>新規口座開設キャンペーンとの併用は不可です。両方に申し込んだ場合は本キャンペーンが優先されます。</li>
          <li>売建玉のスワップポイントは対象外です。</li>
          <li>裁量（マニュアル）取引と自動売買のどちらも対象です。</li>
          <li>1万通貨未満の買建玉も集計対象です。上乗せ額は終了後に合計し、小数点は切り捨てです。</li>
          <li>集計時に口座を解約済み、またはトライオートFX口座残高が0円の場合は対象外です。</li>
        </ul>
      </p>
    </div>

    <h3>【まとめ：10万通貨までなら効率は良い。買い増すならエントリーだけは済ませる】</h3>
    <p>
      単価12.2円/日は公式値どおりで、上乗せ後の実質36.3円相当は当サイト集計の他社をすべて上回ります。<br>
      弱点は規模です。上限10万通貨・約3週間なので、フル保有しても約2,684円。大口の人には物足りない内容です。<br>
      逆に10万通貨以内で運用している人にとっては、上限の縮小はデメリットになりません。もともとトルコリラ/円を買い増す予定があるなら、申し込みは無料なので忘れずに済ませておきましょう。<br>
      次回は上限の回復を期待したいところです。
    </p>
  `,
},
