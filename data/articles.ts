...
・今回は最大30％。先月の60％から半減
・公式シミュレーション合計は40,955円相当
・上限Lotをフル保有で約168,750円相当（当サイト試算）
・エントリーと『らくらくFX積立』口座が必須`,
  date: '2026/08/28',
  ...
  content: `
    ...
    <h3>【30％で他社に勝てる？ スプレッドを引くと長期は負けます】</h3>
    <p>米ドル/トルコリラ・ユーロ/トルコリラを扱う業者は少ないため、他社で「トルコリラ/円 買＋米ドル/円 売」などを組んだ合成ポジションと比べました。増額後なら、わずかに上回ります。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア</th>
      ...
      <tbody>
        <tr>
          ...
          <td>約1,067円（GMOクリック証券）</td>
          <td>＋21円</td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売）</td>
          <td><strong>約1,313円</strong></td>
          <td>約1,303円（GMOクリック証券）</td>
          <td>＋10円</td>
        </tr>
      </tbody>
    </table>
    ...
    <p>ただし、<strong>このキャンペーンは毎月ポジションを建て直す必要があり、そのたびにスプレッドを払います</strong>。外為どっとコムのスプレッドは米ドル/トルコリラ30pips・ユーロ/トルコリラ50pips（変動、他社より広い）で、1万通貨あたり993円・1,656円かかります。これを引くと結論が逆転します。</p>
    <ul>
      <li><strong>米ドル/トルコリラ：約15ヶ月</strong>より長く保有するなら、他社の合成の方が有利</li>
      <li><strong>ユーロ/トルコリラ：約6ヶ月</strong>より長く保有するなら、他社の合成の方が有利</li>
    </ul>
    <p>先月の60％増額なら、毎月スプレッドを払っても合成に勝ち続けられました。30％になったことで、<strong>数ヶ月単位で回すなら妙味あり、何年も持つなら他社で持ちっぱなしのほうが有利</strong>、という水準に変わっています。</p>
    <p style="font-size: 0.9em; color: #666;">※当サイト試算です。スワップは外為どっとコムの平均値集計期間（2026年7月27日〜8月21日）に揃えた各社平均、レートは2026年8月27日時点。合成側のスプレッドも初回コストとして計上しています。合成は2〜3ポジション必要で、証拠金や管理の手間は別途かかります。</p>
