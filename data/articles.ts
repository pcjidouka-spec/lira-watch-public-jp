...
{
  id: 'm2j-try-swap-campaign-202608',
  title: 'マネースクエアの「トルコリラ/円スワップ20％増額キャンペーン」が開催中！実質スワップは1万通貨あたり30円で業界トップ級に',
  share_title: 'トルコリラ/円スワップ20％増額（マネースクエア）',
  date: '2026/08/02',
  thumbnail: '/images/m2j-try-swap-campaign-202608_60.png',
  tags: ['FX', 'トルコリラ', 'スワップ投資', 'マネースクエア', 'キャンペーン'],
  content: `
    <p class="intro">
      マネースクエアにて、<strong>「トルコリラ/円スワップ20％増額キャンペーン」</strong>が開催中です（2026年7月27日〜9月30日）。<br>
      期間中の<strong>入出金純増額100万円以上</strong>を達成し、新たにトルコリラ/円のポジションを持つと、<strong>受取りスワップの20％がキャッシュバック</strong>されます。約2か月間と長めの開催です。
    </p>

    <h3>【まずは結論：実質スワップはいくらになる？】</h3>
    <p>マネースクエアは2026年7月24日にトルコリラ/円の買スワップを引き上げており、当サイトの実測では<strong>1万通貨あたり25円/日</strong>で推移しています。ここに20％のキャッシュバックが乗るため、実質は次のようになります。</p>
    <ul>
      <li>通常の買スワップ：<strong>25円</strong>（1万通貨・1日あたり／当サイト実測）</li>
      <li>キャッシュバック：<strong>＋5円</strong>（25円 × 20％）</li>
      <li>実質：<span style="color: #ef4444; font-weight: bold;">30円相当</span>（1万通貨・1日あたり）</li>
    </ul>
    <p style="font-size: 0.9em; color: #666;">※スワップ値は当サイトが毎日取得している実測値（2026年7月30日時点）です。キャッシュバック額は公式の計算式に当てはめた当サイト試算で、スワップは日々変動します。</p>

    <h3>【他社と比べるとどうか（当サイト実測・2026年7月30日）】</h3>
    <p>同日のトルコリラ/円 買スワップ（1万通貨・1日あたり）を並べると、マネースクエアは通常時点ですでに最上位グループです。20％上乗せ後の実質30円は、単独トップの水準になります。</p>
    <table class="article-table">
      ...
      <tbody>
        <tr>
          <td><strong>マネースクエア</strong></td>
          <td><strong>25.0円</strong></td>
          <td><strong style="color: #ef4444;">30.0円相当</strong></td>
        </tr>
        <tr>
          <td>GMOクリック証券</td>
          <td>25.0円</td>
        ...
        <tr>
          <td>GMO外貨 / トライオートFX</td>
          <td>24.1円</td>
          <td>—</td>
        </tr>
        <tr>
          <td>DMM FX / 外為どっとコム / ヒロセ通商 / JFX / MATSUI FX</td>
          <td>24.0円</td>
          <td>—</td>
        </tr>
        <tr>
          <td>みんなのFX / LIGHT FX</td>
          <td>23.2〜23.3円</td>
          <td>—</td>
        </tr>
        <tr>
    ...
    <p style="font-size: 0.9em; color: #666;">※当サイトのランキングは直近30日の平均で集計しているため、7月23日まで買スワップが6円だったマネースクエアは現時点では下位に表示されます。引き上げ後（7月24日以降）の実測は25円で安定しています。</p>

    <h3>【日次キャッシュバック早見表】</h3>
    <p>公式の計算式は<strong>「（対象ポジション数量 ÷ 1万通貨）×（1万通貨1日あたり買いスワップ × 20％）」</strong>です。買スワップ25円で計算すると、1日あたりのキャッシュバックは次の通りです。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象ポジション数量</th>
          <th>1日あたりのキャッシュバック</th>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <tr>
          <td>150万通貨</td>
          <td>750円<span style="font-size: 0.85em; color: #666;">（公式の計算例）</span></td>
        </tr>
        <tr>
          <td><strong>300万通貨（上限）</strong></td>
          <td><strong style="color: #ef4444;">1,500円</strong><span style="font-size: 0.85em; color: #666;">（公式の計算例・1日の上限）</span></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※1日あたりのキャッシュバック対象は300万通貨が上限です（＝1日あたり最大1,500円、買スワップ25円の場合）。公式サイトも買スワップ25円を仮定して同じ数値を掲載しています。</p>

    <h3>【上限まで建てたら？キャンペーン期間中の最大キャッシュバック】</h3>
    <p>上限の300万通貨を期間中ずっと保有した場合のキャッシュバック総額は、当サイト試算で次の通りです。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象ポジション数量</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><strong style="color: #ef4444;">約99,000円</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※7月27日〜9月30日の暦日数（66日）を付与日数の目安として、買スワップ25円で計算した当サイト試算です。スワップは日々変動し、付与日数も実際のカレンダーで前後します。<strong>この記事の公開時点（8月2日）から新規に建てる場合、残りは約60日分</strong>となり、300万通貨で約90,000円が目安です。300万通貨の建玉には相応の証拠金が必要で、為替変動による損失リスクもあります。あくまで上限の目安としてご覧ください。</p>

    <h3>【キャンペーン概要】</h3>
    <div class="campaign-details">
      <ul>
        <li><strong>キャンペーン名：</strong> トルコリラ/円スワップ20％増額キャンペーン</li>
        <li><strong>対象期間：</strong> 2026年7月27日(月)7時20分 ～ 2026年10月1日(木)5時50分</li>
        <li><strong>条件：</strong> 期間中の入出金純増額（入金合計−出金合計）が100万円以上</li>
        <li><strong>対象通貨ペア：</strong> トルコリラ/円（TRY/JPY）</li>
        <li><strong>特典：</strong> 対象ポジションに発生した買いスワップの20％をキャッシュバック</li>
        <li><strong>1日あたりの上限：</strong> 対象ポジション数量300万通貨まで</li>
        <li><strong>キャッシュバック日：</strong> 2026年10月30日(金)にFX口座へ入金</li>
        <li><strong>注文種別：</strong> トラリピ注文・ストリーミング注文など、種別は問わない</li>
      </ul>
    </div>

    <h3>【参加するための必須条件・注意点】</h3>
    <ul>
      <li>キャンペーンページの<strong>「エントリー」ボタンのクリックが必須</strong>です。ただし期間内であれば、エントリー前のお取引・入出金純増額もさかのぼって計算の対象になります。</li>
      <li>対象は<strong>キャンペーン期間中に新規成立したポジションのみ</strong>です。開始前から保有しているポジションは対象外です。</li>
      <li>対象数量は<strong>買いポジションから売りポジションを差し引いた数量</strong>で判定されます。差引後が0以下の場合は対象外です。</li>
      <li>入出金純増額は<strong>2026年9月30日(水)のNYクローズ時点</strong>で判定されます。FX/CFD口座間の証拠金振替はカウントされません。</li>
      <li>キャッシュバックは<strong>FX口座への入金</strong>であり、取引画面のスワップ残高が増額されるわけではありません。</li>
      <li>キャッシュバック日（10月30日）にFX口座を保有していない場合、受け取れません。</li>
      <li>日次計算で生じた1円未満の端数は累計され、期間合計で1円未満が切り捨てられます。</li>
      <li>金利情勢によっては買いスワップが支払いに転じる場合があります。スワップが逆転した場合は、売りポジション側で計算されます。</li>
    </ul>

    <hr style="margin: 30px 0; border: 0; border-top: 1px solid #eee;">

    <p>
      トルコリラは高スワップが魅力な一方、相場の急変動リスクがある通貨です。<br>
      マネースクエアは7月下旬にトルコリラ/円のスワップを引き上げており、そこに20％のキャッシュバックが2か月間乗る形になります。100万円以上の入金という条件はありますが、まとまった資金でトルコリラを長期保有する方には狙い目です。エントリーを忘れないようにしましょう。
    </p>

    <div class="campaign-link" style="margin-top: 30px;">
      <p style="font-weight: bold; color: #2563eb;">▼キャンペーンの詳細とエントリーはこちら</p>
      <a href="https://www.m2j.co.jp/campaign" target="_blank" rel="noopener noreferrer">
        https://www.m2j.co.jp/campaign
      </a>
      <p style="font-size: 0.9em; color: #666; margin-top: 8px;">※エントリーは会員ページ（ログイン必須）から行います。最新の条件・注意事項は必ず公式ページでご確認ください。</p>
    </div>
  `,
},
{
  id: 'gaitame-swap-campaign-202608',
  title: '外為どっとコムの「スワップポイント最大60％増額キャンペーン」が8月も開催！米ドル/トルコリラ・ユーロ/トルコリラは最大60％上乗せ',
  share_title: 'スワップ最大60％増額キャンペーンが8月も開催！（外為どっとコム）',
  date: '2026/08/01',
  thumbnail: '/images/gaitame-swap-campaign-202608_60.png',
  tags: ['FX', 'トルコリラ', 'スワップ投資', '外為どっとコム', 'キャンペーン'],
  content: `
    <p class="intro">
      外為どっとコムにて、2026年8月も<strong>「入金額に応じてスワップポイント最大60％増額キャンペーン」</strong>が開催されます。<br>
      <strong>100万円以上の入金で米ドル/トルコリラ・ユーロ/トルコリラが60％増額</strong>。10万円以上の入金でも30％増額が受けられます。
    </p>

    <h3>【まずは結論：合計でいくら上乗せ？】</h3>
    <p>公式シミュレーションでは、対象3通貨ペアを組み合わせて運用すると、合計で次のポイントが上乗せされます。</p>
    <ul>
      <li><strong>入金100万円以上：</strong> 合計 <span style="color: #ef4444; font-weight: bold;">64,960円相当</span> のFXポイント上乗せ</li>
      <li><strong>入金10万円以上〜100万円未満：</strong> 合計 <span style="color: #ef4444; font-weight: bold;">31,730円相当</span> のFXポイント上乗せ</li>
    </ul>

    <h3>【通貨ペア別：増額率に注意（通貨ペアで率が異なります）】</h3>
    <p>今回も入金額と通貨ペアによって増額率が変わります。トルコリラ/円（買）の増額率は他2ペアより低い点に注意してください。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        <tr>
          <td>米ドル/トルコリラ（売）</td>
          <td>30％</td>
          <td><strong style="color: #ef4444;">60％</strong></td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売）</td>
          <td>30％</td>
    ...
    <h3>【通貨ペア別：シミュレーション内訳（最大増額時）】</h3>
    <p>合計64,960円相当の内訳は、公式シミュレーションで3通貨ペアそれぞれ次の保有例で計算されています（1Lot＝1,000通貨）。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        <tr>
          <td>米ドル/トルコリラ（売・60％）</td>
          <td>10万通貨を6日間（8/3建て〜8/7決済）</td>
          <td><strong>28,380円相当</strong></td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売・60％）</td>
          <td>10万通貨を5日間＋5万通貨を1日間（8/10建て〜8/14決済）</td>
          <td><strong>31,900円相当</strong></td>
        </tr>
        <tr>
          <td>トルコリラ/円（買・30％）</td>
          <td>50万通貨を13日間（8/17建て〜8/28決済）</td>
          <td><strong>4,680円相当</strong></td>
        </tr>
        <tr>
          <td><strong>合計</strong></td>
          <td>—</td>
          <td><strong style="color: #ef4444;">64,960円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※入金10万円以上〜100万円未満の場合は、米ドル/トルコリラ・ユーロ/トルコリラが30％（上記の半分）、トルコリラ/円が10％（上記の3分の1）となり、公式では合計31,730円相当です。</p>

    <h3>【通貨ペア別：1日あたりの上乗せ目安】</h3>
    <p>最大増額（米ドル/トルコリラ・ユーロ/トルコリラ60％、トルコリラ/円30％）が適用された場合、一定数量を1日保有したときの上乗せ目安は次の通りです。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
    ...
    <p style="font-size: 0.9em; color: #666;">※公式シミュレーションの1Lotあたり単価（米ドル/トルコリラ47.30円、ユーロ/トルコリラ58.00円、トルコリラ/円0.72円）から換算した目安です。</p>

    <h3>【上限Lotまで建てたら？キャンペーン期間中、最大上乗せ】</h3>
    <p>上乗せ対象の上限数量を全ペア同時に建て、キャンペーン期間をフルに保有した場合、上乗せは最大で次の通りです（公式単価からの当サイト試算）。</p>
    <p style="font-size: 0.9em; color: #666;">※付与日数は27日で計算（公式シミュレーション例から逆算。8月3日建て〜8月28日金曜クローズ、水曜クローズは3日分付与のため）。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>—</td>
          <td>約11,250円</td>
          <td><strong style="color: #ef4444;">約303,750円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※入金100万円以上（最大増額）で全ペア上限Lotをフル期間保有した理論上の最大値です。10万円以上〜100万円未満の増額時は約148,770円相当。実際にはこの規模の建玉には多額の証拠金が必要で、スワップも日々変動します。あくまで上限の目安としてご覧ください。</p>

    <h3>【キャンペーン概要】</h3>
    <div class="campaign-details">
      <ul>
        <li><strong>対象期間：</strong> 2026年8月3日(月)午前7時00分 ～ 2026年8月29日(土)午前5時55分</li>
        <li><strong>条件：</strong> 期間中の純増額（入金−出金）が10万円以上で30％（トルコリラ/円は10％）増額、100万円以上で60％（トルコリラ/円は30％）増額</li>
        ...
        <li>
          ...
          ・米ドル/トルコリラ・ユーロ/トルコリラ：各100Lot（10万通貨）まで
        </li>
        <li><strong>特典付与：</strong> 2026年9月末までに『らくらくFX積立』口座へFXポイント付与</li>
      </ul>
    </div>
    ...
    <ul>
      ...
      <li>特典のFXポイント（1ポイント＝1円）を受け取るには、期間終了日時時点で<strong>『らくらくFX積立』の口座開設</strong>が必要です。未開設だと付与対象外になります。</li>
      <li>上乗せ額は、平均値集計期間（2026年6月29日〜7月24日）の受取スワップポイント平均値を基準に算出されます。</li>
      <li>キャンペーン開始前から保有しているポジション、新規建て当日中に決済したポジションは対象外です。</li>
      <li>トルコリラ/円（買）の増額率は他2ペアより低い（最大30％）点に注意してください。</li>
      <li>FXポイントの有効期限は、最後に獲得または利用した日から180日間です。</li>
    </ul>
    ...
    <div class="campaign-link" style="margin-top: 30px;">
      <p style="font-weight: bold; color: #2563eb;">▼キャンペーンの詳細とエントリーはこちら</p>
      <a href="https://www.gaitame.com/campaign/increase-swap-2608/" target="_blank" rel="noopener noreferrer">
        https://www.gaitame.com/campaign/increase-swap-2608/
      </a>
    </div>
  `,
},
{
  id: 'sbi-fxtrade-swap-campaign-202608',
  title: 'SBI FXトレード「高金利3通貨！真夏のスワップ20％増額キャンペーン」が開催！トルコリラ・南アランド・メキシコペソの全3通貨が20％キャッシュバック',
  share_title: 'SBI FXトレード 高金利3通貨スワップ20％増額キャンペーン開催！',
  date: '2026/08/01',
  thumbnail: '/images/sbi-fxtrade-swap-campaign-202608_card.jpg',
  tags: ['FX', 'トルコリラ', 'メキシコペソ', '南アフリカランド', 'スワップ投資', 'SBI FXトレード', 'キャンペーン'],
  content: `
    <p class="intro">
      SBI FXトレードにて、高金利通貨3ペアを対象とした<strong>「高金利3通貨！真夏のスワップ20％増額キャンペーン！」</strong>が開催されます。<br>
      期間中に新規建てしたポジションの<strong>受取スワップポイントの20％相当額がキャッシュバック</strong>される内容で、約2か月のロングランです。
    </p>

    <h3>【まずは結論：3通貨とも20％キャッシュバック】</h3>
    <p>前回（初夏キャンペーン）はメキシコペソのみ10％でしたが、今回は<strong>3通貨すべてが20％</strong>にそろいました。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア</th>
    ...
    <p style="font-size: 0.9em; color: #666;">※受取スワップポイントの「20％相当額」が後日キャッシュバックされる仕組みです。取引画面上のスワップポイント自体が増額されるわけではありません。※メキシコペソの上限は前回の1,400万通貨から700万通貨に変更されています。</p>

    <h3>【仕組み：日次で受取スワップの20％を還元】</h3>
    <ul>
      <li>各営業日の終了時点で保有する対象建玉に対し、受取スワップポイントを<strong>日次で計算</strong>。</li>
      <li>その合計額に20％を乗じた金額を還元。</li>
      <li>キャッシュバックは<strong>2026年10月末頃に</strong>まとめてFX口座へ入金されます。</li>
      <li>対象数量は買建玉から売建玉を差し引いた数量。1円未満は切り捨て。</li>
    </ul>

    <h3>【上限建玉で全期間保有したら？最大キャッシュバック試算】</h3>
    <p>対象建玉の上限まで建て、キャンペーン全期間（約2か月）保有した場合のキャッシュバックを、当サイトの直近スワップ実績から試算しました。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>通貨ペア</th>
          <th>上限建玉 × 期間の受取スワップ目安</th>
          <th>キャッシュバック試算（20％）</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td>トルコリラ/円</td>
          <td>約407,000円（23円／1万通貨・日 × 300万通貨 × 59日）</td>
          <td><strong>約81,400円相当</strong></td>
        </tr>
        <tr>
          <td>南アフリカランド/円</td>
          <td>約578,000円（14円／1万通貨・日 × 700万通貨 × 59日）</td>
          <td><strong>約115,600円相当</strong></td>
        </tr>
        <tr>
          <td>メキシコペソ/円</td>
          <td>約578,000円（14円／1万通貨・日 × 700万通貨 × 59日）</td>
        ...
        <tr>
          <td><strong>3通貨合計</strong></td>
          <td>—</td>
          <td><strong style="color: #ef4444;">約312,700円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※直近のSBI FXトレードの買スワップ（トルコリラ/円23円、南アフリカランド/円14円、メキシコペソ/円14円／各1万通貨・1日あたり）を用いた当サイト試算です。スワップは日々変動し、上限建玉には多額の証拠金が必要です。あくまで上限の目安としてご覧ください。</p>

    <h3>【少額・低レバレッジでも数千円相当】</h3>
    <p>上限いっぱいでなくても大丈夫です。たとえば<strong>3通貨を各10万通貨ずつ、リスクを抑えた低レバレッジで全期間保有</strong>した場合でも、次のキャッシュバックが見込めます。</p>
    <ul>
      <li>トルコリラ/円 10万通貨：<strong>約2,700円相当</strong></li>
      <li>南アフリカランド/円 10万通貨：<strong>約1,650円相当</strong></li>
      <li>メキシコペソ/円 10万通貨：<strong>約1,650円相当</strong></li>
      <li><strong style="color: #ef4444;">3通貨合計：約6,000円相当</strong></li>
    </ul>
    <p style="font-size: 0.9em; color: #666;">※同じく直近スワップ実績と全期間59日での試算です。10万通貨なら必要証拠金も比較的小さく、少額でもコツコツ上乗せを狙えます。</p>

    <h3>【キャンペーン概要】</h3>
    <div class="campaign-details">
      <ul>
        <li><strong>対象期間：</strong> 2026年8月3日(月)午前7時00分 ～ 2026年10月1日(木)午前5時30分</li>
        <li><strong>エントリー締切：</strong> 2026年10月1日(木)午前5時30分</li>
        ...
        <li><strong>入金時期：</strong> 2026年10月末頃</li>
      </ul>
    </div>
    ...
    <ul>
      ...
      <li>複数口座を持っている場合、最新のエントリー日時の口座のみが対象になります。</li>
    ...
    <p>
      トルコリラ・南アフリカランド・メキシコペソはいずれも高金利通貨で、スワップ狙いの長期保有と相性の良い通貨です。新興国通貨ゆえの価格変動リスクはありますが、今回は3通貨とも20％と条件がそろっており、受取スワップの上乗せを狙いやすい内容です。<br>
      まずは詳細をチェックし、エントリーを済ませておきましょう。
    </p>

    <div class="campaign-link" style="margin-top: 30px;">
      <p style="font-weight: bold; color: #2563eb;">▼キャンペーンの詳細とエントリーはこちら</p>
      <a href="https://www.sbifxt.co.jp/campaign/swappoint_202608.html" target="_blank" rel="noopener noreferrer">
        https://www.sbifxt.co.jp/campaign/swappoint_202608.html
      </a>
    </div>
  `,
},
{
  id: 'triauto-campaign-20260715',
  title: 'トライオートFX：トルコリラ/円のスワップが20％増額（7/15〜7/31）1万通貨あたり5.1円/日を上乗せ',
  share_title: 'トルコリラ/円スワップ20％増額（トライオートFX）',
  date: '2026/07/16',
  thumbnail: '/images/triauto-campaign-20260715_60.png',
  tags: ['FX', 'トルコリラ', 'スワップ投資', 'トライオートFX', 'キャンペーン'],
  content: `
    <p class="intro">
      トライオートFXが、トルコリラ/円のスワップポイントを<strong>20％上乗せ</strong>するキャンペーンを開催中です。<br>
      上乗せ額は<strong>1万通貨あたり5.1円/日</strong>。期間は<strong>2026年7月15日（水）〜7月31日（金）</strong>と約2週間しかありません。<br>
      ただし先に言っておくと、<strong>今回はささやかです。</strong>上限まで建てても総額は約4,845円。5月の同じキャンペーン（当サイト試算で約19,575円）の4分の1です。
    </p>

    <h3><a href="https://www.invast.jp/triauto/campaign/fx/tryswap/202607try/" target="_blank" rel="noopener noreferrer">トライオートFX：トルコリラ/円スワップポイント20％増額キャンペーン</a></h3>
    <p class="campaign-title" style="color: #ef4444; font-weight: bold; font-size: 1.1em;">申込フォームからのエントリーが必須です。申し込まないと1円も増えません。</p>

    <h3>【まずは結論：いくら上乗せされる？】</h3>
    <p>上乗せ単価は公式発表で <strong>1万通貨あたり5.1円/日</strong>。建玉の上限は50万通貨です。</p>
    <ul>
      <li><strong>1万通貨：</strong> 5.1円/日（公式）</li>
      <li><strong>上限の50万通貨：</strong> <span style="color: #ef4444; font-weight: bold;">255円/日</span>（当サイト試算）</li>
      <li><strong>50万通貨を全期間フル保有：</strong> <span style="color: #ef4444; font-weight: bold;">約4,845円</span>（当サイト試算）</li>
    </ul>

    <h3>【数量別の上乗せ額（当サイト試算）】</h3>
    <table class="article-table">
      <thead>
        <tr>
          <th>買建玉の増加分</th>
      ...
      <tbody>
        <tr><td>10万通貨</td><td>51円</td><td>約969円</td></tr>
        <tr><td>20万通貨</td><td>102円</td><td>約1,938円</td></tr>
        <tr><td>30万通貨</td><td>153円</td><td>約2,907円</td></tr>
        <tr><td>50万通貨（上限）</td><td>255円</td><td>約4,845円</td></tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">
      ※公式が発表しているのは「1万通貨あたり5.1円/日」のみです。上の表は当サイトが5.1円/日を掛け算した試算です。<br>
      ※全期間は7月15日から7月31日まで建玉を持ち続けた場合の付与日数19日（水曜クローズは3日分）で計算しています。実際の付与日数は変動します。<br>
      ※50万通貨を建てるには相応の証拠金が必要です。為替変動による損失がスワップの上乗せ分を上回る可能性があります。
    </p>

    <h3>【正直な評価：今回はささやかすぎます。5月の4分の1です】</h3>
    <p>上限いっぱいの50万通貨を建てても、全期間で約4,845円。<strong>同じトライオートFXが5月にやったキャンペーンと比べると、ちょうど4分の1</strong>です。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th></th>
      ...
      <tbody>
        <tr><td>増額率</td><td>50％</td><td><span style="color: #ef4444; font-weight: bold;">20％</span></td></tr>
        <tr><td>上乗せ単価（1万通貨）</td><td>13.5円/日</td><td>5.1円/日</td></tr>
        <tr><td>期間</td><td>5/1〜5/29（約4週間）</td><td>7/15〜7/31（約2週間）</td></tr>
        <tr><td>建玉上限</td><td>50万通貨</td><td>50万通貨</td></tr>
        <tr><td>上限フル保有の上乗せ額<br>（当サイト試算）</td><td>約19,575円</td><td><span style="color: #ef4444; font-weight: bold;">約4,845円</span></td></tr>
      </tbody>
    </table>
    <p>
      ここで注目したいのは、<strong>スワップ水準そのものはほとんど下がっていない</strong>ことです。<br>
      上乗せ単価から逆算すると、元になったスワップは5月が27.0円、今回が25.5円。差は約5％しかありません。<br>
      それでも上乗せ総額が4分の1になったのは、増額率を50％→20％に下げ、期間も約4週間→約2週間に縮めたからです。
    </p>
    <p>
      2026年2月のキャンペーンはさらに手厚く、スワップ60％増額に加えて建玉上限も100万通貨と今回の倍でした。<br>
      トルコリラ/円のスワップ投資を続けている人ほど、今回の内容は物足りなく感じるはずです。<strong>もう一段の増額を期待したいところです。</strong>
    </p>
    <p style="font-size: 0.9em; color: #666;">
      ※フォローしておくと、上乗せを含めた実質のスワップは強力です。当サイト集計（直近約2週間・7月14日時点）のトルコリラ/円の買スワップ平均は、GMOクリック証券25.44円、JFX 25.00円、トライオートFX 24.81円で、トライオートFXは3位。ここに5.1円が上乗せされる計算なので、キャンペーン期間中は実質トップ相当になります。物足りないのは「率と規模」であって、スワップの実力ではありません。
    </p>

    <h3>【対象は「増加分」だけ。すでに持っている建玉は対象外】</h3>
    <p>ここが一番の注意点です。対象になるのは<strong>基準日より増えた分</strong>だけです。</p>
    <ul>
      <li><strong>基準日：</strong> 2026年7月14日（火）クローズ時点の建玉数量</li>
      <li><strong>例1：</strong> 基準日に買建玉なし → 新規の買建玉すべてが対象（上限50万通貨）</li>
      <li><strong>例2：</strong> 基準日に10万通貨保有 → 15万通貨に増やすと、増加分の5万通貨だけが対象</li>
    </ul>
    <p>つまり、すでにトルコリラ/円を建てている人ほど、上乗せを受けるには買い増しが必要になります。</p>

    <div class="campaign-details">
      <p><strong>開催期間：</strong> 2026年7月15日（水）取引開始 ～ 7月31日（金）取引終了</p>
      <p><strong>対象者：</strong> キャンペーン期間中に応募フォームから申し込みを行ったお客様</p>
      <p><strong>特典内容：</strong> トルコリラ/円（TRY/JPY）の新規買建玉の増加分に対し、スワップポイントを20％上乗せしてキャッシュバック</p>
      <p><strong>上乗せ単価：</strong> 1万通貨あたり5.1円/日（2026年6月1日〜6月30日の受取スワップポイント平均値の20％）</p>
      <p><strong>対象建玉の上限：</strong> 50万通貨</p>
      <p><strong>入金時期：</strong> 2026年8月末まで（キャンペーン期間終了後にまとめて入金）</p>
      <p><strong>注意事項：</strong>
        <ul>
          <li>申込フォームからのエントリーが必要です。登録がない場合や入力不備がある場合は対象外です。</li>
          <li>新規口座開設キャンペーンとの併用は不可です。両方に申し込んだ場合は本キャンペーンが優先されます。</li>
          <li>売建玉のマイナススワップは対象外です。</li>
          <li>裁量（マニュアル）取引と自動売買のどちらも対象です。</li>
          <li>期間の途中で申し込んでも、期間中の増加分はすべて対象になります（上限50万通貨）。</li>
          <li>1万通貨未満の買建玉も集計対象です。上乗せ額は終了後に合計し、小数点は切り捨てです。</li>
          <li>集計時に口座を解約済み、または口座残高が0円の場合は対象外です。</li>
        </ul>
      </p>
    </div>

    <h3>【まとめ：規模は物足りない。それでも買い増すならエントリーは必須】</h3>
    <p>
      期間は約2週間、対象は「増加分」のみ、上限まで建てても約4,845円。<br>
      5月の約19,575円と比べて見劣りするのは事実です。上乗せ単価の5.1円/日は、6月のトルコリラ/円の受取スワップ平均値（当サイト集計で約25.9円/日）の20％にあたる水準にすぎません。<br>
      とはいえ、もともとトルコリラ/円を買い増す予定があるなら、エントリーするだけで上乗せが付きます。申し込みは無料です。参加するなら忘れずに済ませておきましょう。<br>
      そして次回は、5月や2月のような思い切った増額を期待したいところです。
    </p>
  `,
},
{
  id: 'gaitame-swap-campaign-202607',
  title: '外為どっとコムの「スワップポイント最大60％増額キャンペーン」が7月も開催！米ドル/トルコリラ・ユーロ/トルコリラは最大60％上乗せ',
  share_title: 'スワップ最大60％増額キャンペーンが7月も開催！（外為どっとコム）',
  date: '2026/06/26',
  thumbnail: '/images/gaitame-swap-campaign-202607_60.png',
  tags: ['FX', 'トルコリラ', 'スワップ投資', '外為どっとコム', 'キャンペーン'],
  content: `
    <p class="intro">
      外為どっとコムにて、2026年7月も<strong>「入金額に応じてスワップポイント最大60％増額キャンペーン」</strong>が開催されます。<br>
      今回は約5週間とロングランで、<strong>100万円以上の入金で米ドル/トルコリラ・ユーロ/トルコリラが60％増額</strong>。10万円以上の入金でも30％増額が受けられます。
    </p>

    <h3>【まずは結論：合計でいくら上乗せ？】</h3>
    <p>公式シミュレーションでは、対象3通貨ペアを組み合わせて運用すると、合計で次のポイントが上乗せされます。</p>
    <ul>
      <li><strong>入金100万円以上：</strong> 合計 <span style="color: #ef4444; font-weight: bold;">75,040円相当</span> のFXポイント上乗せ</li>
      <li><strong>入金10万円以上〜100万円未満：</strong> 合計 <span style="color: #ef4444; font-weight: bold;">約36,700円相当</span> のFXポイント上乗せ（当サイト試算）</li>
    </ul>

    <h3>【通貨ペア別：増額率に注意（今回は通貨ペアで率が異なります）】</h3>
    <p>今回のキャンペーンは、入金額と通貨ペアによって増額率が変わります。トルコリラ/円（買）の増額率は他2ペアより低い点に注意してください。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
    ...
    <h3>【通貨ペア別：シミュレーション内訳（最大増額時）】</h3>
    <p>合計75,040円相当の内訳は、公式シミュレーションで3通貨ペアそれぞれ次の保有例で計算されています（1Lot＝1,000通貨）。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        <tr>
          <td>米ドル/トルコリラ（売・60％）</td>
          <td>10万通貨を6日間</td>
          <td><strong>32,160円相当</strong></td>
        </tr>
        <tr>
          <td>ユーロ/トルコリラ（売・60％）</td>
          <td>10万通貨を5日間＋5万通貨を1日間</td>
          <td><strong>38,005円相当</strong></td>
        </tr>
        <tr>
          <td>トルコリラ/円（買・30％）</td>
          <td>50万通貨を13日間</td>
          <td><strong>4,875円相当</strong></td>
        </tr>
        <tr>
          <td><strong>合計</strong></td>
          <td>—</td>
          <td><strong style="color: #ef4444;">75,040円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※入金10万円以上〜100万円未満の場合は、米ドル/トルコリラ・ユーロ/トルコリラが30％（上記の半分）、トルコリラ/円が10％（上記の3分の1）となり、合計約36,700円相当が目安です。</p>
    ...
    <h3>【上限Lotまで建てたら？キャンペーン期間中、最大上乗せ】</h3>
    <p>上乗せ対象の上限数量を全ペア同時に建て、キャンペーン期間をフルに保有した場合、上乗せは最大で次の通りです（公式単価からの当サイト試算）。</p>
    <p style="font-size: 0.9em; color: #666;">※付与日数は34日で計算（公式シミュレーション例から逆算。6月29日建て〜7月31日金曜クローズ、水曜クローズは3日分付与のため）。</p>
    <table class="article-table">
      <thead>
        <tr>
          <th>対象通貨ペア・ポジション</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>—</td>
          <td>約13,020円</td>
          <td><strong style="color: #ef4444;">約442,680円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※入金100万円以上（最大増額）で全ペア上限Lotをフル期間保有した理論上の最大値です。10万円以上〜100万円未満の増額時は約217,090円相当。実際にはこの規模の建玉には多額の証拠金が必要で、スワップも日々変動します。あくまで上限の目安としてご覧ください。</p>

    <h3>【キャンペーン概要】</h3>
    <div class="campaign-details">
      <ul>
        <li><strong>対象期間：</strong> 2026年6月29日(月)午前7時00分 ～ 2026年8月1日(土)午前5時55分</li>
        <li><strong>条件：</strong> 期間中の純増額（入金−出金）が10万円以上で30％（トルコリラ/円は10％）増額、100万円以上で60％（トルコリラ/円は30％）増額</li>
        <li><strong>対象：</strong> 『外貨ネクストネオ』でのトルコリラ/円（買）、米ドル/トルコリラ（売）、ユーロ/トルコリラ（売）の新規ポジション</li>
        <li>
          <strong>上乗せ上限数量：</strong><br>
    ...
    <ul>
      <li>専用フォームからの<strong>「エントリー」</strong>が必須です。入金・取引後でも、期間内のエントリーなら有効です。</li>
      <li>特典のFXポイント（1ポイント＝1円）を受け取るには、期間終了日時時点で<strong>『らくらくFX積立』の口座開設</strong>が必要です。未開設だと付与対象外になります。</li>
      <li>上乗せ額は、平均値集計期間（2026年5月25日〜6月19日）の受取スワップポイント平均値を基準に算出されます。</li>
      <li>トルコリラ/円（買）の増額率は他2ペアより低い（最大30％）点に注意してください。</li>
    </ul>
    ...
    <div class="campaign-link" style="margin-top: 30px;">
      <p style="font-weight: bold; color: #2563eb;">▼キャンペーンの詳細とエントリーはこちら</p>
      <a href="https://www.gaitame.com/campaign/increase-swap-2607/" target="_blank" rel="noopener noreferrer">
        https://www.gaitame.com/campaign/increase-swap-2607/
      </a>
    </div>
  `,
},
  ...
  content: `
    ...
    <table class="article-table">
      ...
      <tbody>
        <tr>
          <td>トルコリラ/円（CB20％）</td>
          <td>約439,000円（24円／1万通貨・日 × 300万通貨 × 61日）</td>
          <td><strong>約87,800円相当</strong></td>
        </tr>
        <tr>
          <td>南アフリカランド/円（CB20％）</td>
          <td>約555,000円（13円／1万通貨・日 × 700万通貨 × 61日）</td>
          <td><strong>約111,000円相当</strong></td>
        </tr>
        <tr>
          <td>メキシコペソ/円（CB10％）</td>
          <td>約1,196,000円（14円／1万通貨・日 × 1,400万通貨 × 61日）</td>
          <td><strong>約119,600円相当</strong></td>
        </tr>
        <tr>
          <td><strong>3通貨合計</strong></td>
          <td>—</td>
          <td><strong style="color: #ef4444;">約318,400円相当</strong></td>
        </tr>
      </tbody>
    </table>
    <p style="font-size: 0.9em; color: #666;">※直近のSBI FXトレードの買スワップ（トルコリラ/円24円、南アフリカランド/円13円、メキシコペソ/円14円／各1万通貨・1日あたり。南アランドとメキシコペソは10万通貨あたり130円・140円を1万通貨換算）を用いた試算です。スワップは日々変動し、上限建玉には多額の証拠金が必要です。あくまで上限の目安としてご覧ください。</p>

    <h3>【少額・低レバレッジでも数千円相当】</h3>
    <p>上限いっぱいでなくても大丈夫です。たとえば<strong>3通貨を各10万通貨ずつ、リスクを抑えた低レバレッジで全期間保有</strong>した場合でも、次のキャッシュバックが見込めます。</p>
    <ul>
      <li>トルコリラ/円 10万通貨（CB20％）：<strong>約2,900円相当</strong></li>
      <li>南アフリカランド/円 10万通貨（CB20％）：<strong>約1,600円相当</strong></li>
      <li>メキシコペソ/円 10万通貨（CB10％）：<strong>約850円相当</strong></li>
      <li><strong style="color: #ef4444;">3通貨合計：約5,400円相当</strong></li>
    </ul>
    <p style="font-size: 0.9em; color: #666;">※同じく直近スワップ実績と全期間61日での試算です。10万通貨なら必要証拠金も比較的小さく、少額でもコツコツ上乗せを狙えます。</p>
