    ...
    return (
        <Html lang="ja">
            <Head>
                ...
                <meta name="description" content="トルコリラ円（TRY/JPY）・メキシコペソ円（MXN/JPY）・南アフリカランド円（ZAR/JPY）・ハンガリーフォリント円（HUF/JPY）・ポーランドズロチ円（PLN/JPY）・米ドル円（USD/JPY）・豪ドル円（AUD/JPY）など各FX会社のスワップポイントを毎日比較・アーカイブ。高金利通貨の最新スワップポイントランキング、推移チャート、キャンペーン情報を網羅。" />
